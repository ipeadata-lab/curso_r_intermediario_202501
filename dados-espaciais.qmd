...
O pacote `{sf}` possui dependências que devem ser instalados no computador (e não no R), e que podem ser um pouco complicadas de instalar.
...
Se você tiver problemas para instalar o pacote, tente instalar o pacote diretamente do GitHub:
