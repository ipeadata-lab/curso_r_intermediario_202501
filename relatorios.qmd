...
Para adicionar códigos em Python em um documento Quarto, você pode utilizar o campo de código `python` (ao criar o chunk, em vez de `r`, utilize `python`). Por exemplo:
