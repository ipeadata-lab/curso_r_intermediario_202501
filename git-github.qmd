...
A seguir, vamos explorar como: 1) criar um novo repositório do Git a partir de um projeto existente no RStudio, e 2) como fazer uma cópia de um repositório que está no GitHub para o RStudio. 
...
### Fazer uma cópia de um repositório que está no GitHub para o computador (clone)
